    ...
    <div className='container'>
      <div className='row'>
       <div className='col-12'>
        <button className=' text-white border-0 rounded p-2 fw-bold fs-5 trendingbtn'>Trending</button>
        <hr className='custom-hr'/>
        </div>
        </div> 
        <div className="row">
        <div className='col-1'>
<img src={riceman} alt="ricecrop" />
        </div>
        <div className='col-5'>
<img src={contourfarming} alt="contourfarming" className='contourfarmingimg'/>
        </div>
       <div className='col-5'>
        <div>
                <img src={greenchili} alt="greenchili" className='trendimg'/>
<img src={mixedcrop} alt="" className='mt-3 trendimg'/>
        </div>
{/* <img src={greenchili} alt="greenchili" className='trendimg'/>
<img src={mixedcrop} alt="" className='mt-3 trendimg'/> */}
<div>
<img src={droneflying} alt=""  className='trendimg'/>
<img src={lushgreen} alt="lushgreen"  className='mt-3 trendimg'/>
</div>
